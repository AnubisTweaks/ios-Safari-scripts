...
;(function () {
  ...
  // Shortcut key setting structure
  function inttSettingsUI() {
  }

  // Set the style of shortcut keys
  ...
  // Determine whether it is Chinese, if it is, return directly, otherwise execute
  if (!isArabicPage()) {
    ...
    createElement(
      ...
      function googleTranslateElementInit() {
        ...
        if (~device) {
          ...
          // PC side
          let langIframe = document.querySelector('[title="Language Translation Widget"]')
